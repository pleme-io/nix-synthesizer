...
fn profiles() -> Vec<Profile> {
    vec![
        ...
        Profile::new(
            "nixos-home-data-services",
            ProfileKind::NixOs,
            ProfileLayer::Standalone,
        ),
        Profile::new(
            "nixos-home-media-automation",
            ProfileKind::NixOs,
            ProfileLayer::Standalone,
        ),
        Profile::new(
            "nixos-home-network-extras",
            ProfileKind::NixOs,
            ProfileLayer::Standalone,
        ),
        Profile::new(
            "nixos-home-observability",
            ProfileKind::NixOs,
            ProfileLayer::Standalone,
        ),
        Profile::new(
...
fn clusters() -> Vec<Cluster> {
    vec![
        Cluster::new("plo", "plo", K3sRole::Server).with_flux_auth(FluxAuth::SshKey),
        Cluster::new("zek", "zek", K3sRole::Agent),
        Cluster::new("orion", "orion", K3sRole::Server).with_flux_auth(FluxAuth::HttpsToken),
    ...
    vec![
        FlakeInput::new(
            ...
            FlakeInputUrl::GitHub {
                ...
                branch: Some("nixos-unstable".to_string()),
            },
            NixCommunity,
        ),
        FlakeInput::new(
        ...
        FlakeInput::new(
            "sops-nix",
            FlakeInputUrl::nix_community_gh("sops-nix"),
            NixCommunity,
        )
        .follows(&["nixpkgs"]),
        FlakeInput::new(
            "flake-parts",
            FlakeInputUrl::GitHub {
                org: "hercules-ci".to_string(),
                repo: "flake-parts".to_string(),
                branch: None,
            },
            NixCommunity,
        )
        ...
        FlakeInput::new(
            "kindling-profiles",
            FlakeInputUrl::pleme_gh("kindling-profiles"),
            PlemeIo,
        )
        .follows(&["nixpkgs"]),
        FlakeInput::new(
            "akeyless-nix",
            FlakeInputUrl::pleme_gh("akeyless-nix"),
            PlemeIo,
        )
        .follows(&["nixpkgs"]),
        ...
        FlakeInput::new("codesearch", FlakeInputUrl::pleme_gh("codesearch"), PlemeIo)
            .follows(&["nixpkgs"]),
        FlakeInput::new("kurage", FlakeInputUrl::pleme_gh("kurage"), PlemeIo).follows(&["nixpkgs"]),
        FlakeInput::new("umbra", FlakeInputUrl::pleme_gh("umbra"), PlemeIo).follows(&["nixpkgs"]),
        FlakeInput::new("mado", FlakeInputUrl::pleme_gh("mado"), PlemeIo).follows(&["nixpkgs"]),
        FlakeInput::new("tobira", FlakeInputUrl::pleme_gh("tobira"), PlemeIo).follows(&["nixpkgs"]),
        FlakeInput::new("escriba", FlakeInputUrl::pleme_gh("escriba"), PlemeIo)
            .follows(&["nixpkgs"]),
        FlakeInput::new(
            "shinryu-mcp",
            FlakeInputUrl::pleme_gh("shinryu-mcp"),
            PlemeIo,
        )
        .follows(&["nixpkgs"]),
        FlakeInput::new(
            "slack-forge",
            FlakeInputUrl::pleme_gh("slack-forge"),
            PlemeIo,
        )
        .follows(&["nixpkgs"]),
        FlakeInput::new("teiki", FlakeInputUrl::pleme_gh("teiki"), PlemeIo).follows(&["nixpkgs"]),
        // blackmatter subrepos
        FlakeInput::new(
            "blackmatter",
            FlakeInputUrl::pleme_gh("blackmatter"),
            Blackmatter,
        )
        .follows(&["nixpkgs"]),
        FlakeInput::new(
        ...
        FlakeInput::new(
            "blackmatter-nvim",
            FlakeInputUrl::pleme_gh("blackmatter-nvim"),
            Blackmatter,
        )
        .follows(&["nixpkgs"]),
        FlakeInput::new(
            "blackmatter-claude",
            FlakeInputUrl::pleme_gh("blackmatter-claude"),
            Blackmatter,
        )
        .follows(&["nixpkgs"]),
        FlakeInput::new(
            "blackmatter-desktop",
            FlakeInputUrl::pleme_gh("blackmatter-desktop"),
            Blackmatter,
        )
        .follows(&["nixpkgs"]),
        FlakeInput::new(
            "blackmatter-ghostty",
            FlakeInputUrl::pleme_gh("blackmatter-ghostty"),
            Blackmatter,
        )
        .follows(&["nixpkgs"]),
        FlakeInput::new(
            "blackmatter-kubernetes",
            FlakeInputUrl::pleme_gh("blackmatter-kubernetes"),
            Blackmatter,
        )
        .follows(&["nixpkgs"]),
        FlakeInput::new(
            "blackmatter-secrets",
            FlakeInputUrl::pleme_gh("blackmatter-secrets"),
            Blackmatter,
        )
        .follows(&["nixpkgs"]),
        FlakeInput::new(
            "blackmatter-akeyless",
            FlakeInputUrl::pleme_gh("blackmatter-akeyless"),
            Blackmatter,
        )
        .follows(&["nixpkgs"]),
        FlakeInput::new(
            "blackmatter-atlassian",
            FlakeInputUrl::pleme_gh("blackmatter-atlassian"),
            Blackmatter,
        )
        .follows(&["nixpkgs"]),
        FlakeInput::new(
            "blackmatter-anvil",
            FlakeInputUrl::pleme_gh("blackmatter-anvil"),
            Blackmatter,
        )
        .follows(&["nixpkgs"]),
        FlakeInput::new(
            "blackmatter-cursor",
            FlakeInputUrl::pleme_gh("blackmatter-cursor"),
            Blackmatter,
        )
        .follows(&["nixpkgs"]),
        FlakeInput::new(
            "blackmatter-movie",
            FlakeInputUrl::pleme_gh("blackmatter-movie"),
            Blackmatter,
        )
        .follows(&["nixpkgs"]),
        FlakeInput::new(
            "blackmatter-security",
            FlakeInputUrl::pleme_gh("blackmatter-security"),
            Blackmatter,
        )
        .follows(&["nixpkgs"]),
        FlakeInput::new(
            "blackmatter-direnv",
            FlakeInputUrl::pleme_gh("blackmatter-direnv"),
            Blackmatter,
        )
        .follows(&["nixpkgs"]),
        FlakeInput::new(
            "blackmatter-code",
            FlakeInputUrl::pleme_gh("blackmatter-code"),
            Blackmatter,
        )
        .follows(&["nixpkgs"]),
        FlakeInput::new(
            "blackmatter-github",
            FlakeInputUrl::pleme_gh("blackmatter-github"),
            Blackmatter,
        )
        .follows(&["nixpkgs"]),
        FlakeInput::new(
            "blackmatter-tailscale",
            FlakeInputUrl::pleme_gh("blackmatter-tailscale"),
            Blackmatter,
        )
        .follows(&["nixpkgs"]),
        FlakeInput::new(
            "blackmatter-vpn",
            FlakeInputUrl::pleme_gh("blackmatter-vpn"),
            Blackmatter,
        )
        .follows(&["nixpkgs"]),
    ]
...
fn substrate_builders() -> Vec<SubstrateBuilder> {
    ...
    vec![
        ...
        RustToolRelease {
            tool_name: "hibiki".into(),
            targets: four.clone(),
            has_hm_module: true,
        },
        RustToolRelease {
            tool_name: "kurage".into(),
            targets: four.clone(),
            has_hm_module: true,
        },
        RustToolRelease {
        ...
        RustLibrary {
            crate_name: "garasu".into(),
        },
        RustLibrary {
            crate_name: "egaku".into(),
        },
        RustLibrary {
            crate_name: "shikumi".into(),
        },
        RustLibrary {
            crate_name: "kaname".into(),
        },
        RustLibrary {
            crate_name: "hayai".into(),
        },
        RustLibrary {
            crate_name: "meimei".into(),
        },
        RustLibrary {
            crate_name: "sekkei".into(),
        },
        RustLibrary {
            crate_name: "takumi".into(),
        },
        // Rust services
        RustService {
            service_name: "hanabi".into(),
            has_hm_module: false,
            has_nixos_module: true,
        },
        RustService {
            service_name: "kenshi".into(),
            has_hm_module: false,
            has_nixos_module: true,
        },
        RustService {
            service_name: "shinka".into(),
            has_hm_module: false,
            has_nixos_module: true,
        },
    ]
...
fn secrets() -> Vec<(String, SecretPath)> {
    ...
    let mut out = Vec::new();
    for p in paths_plo {
        out.push(("plo".to_string(), SecretPath::new(p).expect(p)));
    }
    for p in paths_zek {
        out.push(("zek".to_string(), SecretPath::new(p).expect(p)));
    }
    for p in paths_ryn {
        out.push(("ryn".to_string(), SecretPath::new(p).expect(p)));
    }
    out
}
...
mod tests {
    ...
    fn has_aggregator_component() {
        let reg = pleme_nix_registry();
        assert!(
            reg.blackmatter_components
                .iter()
                .any(|c| c.role == ComponentRole::Aggregator)
        );
    }
